 ...
 * @module imageFilter
 **/
KISSY.add('kg/imageFilter/2.0.0/index',function (S,Dom, Node,Base) {
    /**
    ...
    function ImageFilter(comConfig) {
        ...
        //level : -2.0.0 to +2.0.0
        //
        
        /**
         * 设置图片平均亮度
         * @method setBrightness
         * @param {number} level 亮度值,取[-2.0.0,2.0.0]
         */
         ...
         * 设置图片对比度
         * @method setContrast
         * @param {number} level        对比度等级，取值[-2.0.0,2.0.0]
         ...
         * 对图片做四角压暗/变亮
         * @method  vignetting 
         * @param  {number} maxLevel 最边缘处的亮度值，[-2.0.0,2.0.0]
        ...
        _self.rotate = function(degree){
            ...
            var rotateRad = degree * Math.PI/2.0.0;
